...
/// @description Handle proximity, state, interaction readiness, and post-dialogue destruction.
...
// --- NEW: Check for disappearance after dialogue ---
if (is_awaiting_destroy_after_dialog) {
    if (!instance_exists(obj_dialog)) { // Check if the dialogue object is gone
        instance_destroy(); // Destroy the NPC
        exit;               // IMPORTANT: Stop further processing for this instance in this step
    }
}
// --- END NEW ---
