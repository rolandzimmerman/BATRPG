...
/// @description Generic interaction logic triggered by player action. Handles dialogue creation and sets up for potential destruction.
...
if (is_array(_dialog_variable_to_use) && array_length(_dialog_variable_to_use) > 0) {
    ...
    // NEW: Set flag to destroy NPC after this dialogue finishes
    is_awaiting_destroy_after_dialog = true;
